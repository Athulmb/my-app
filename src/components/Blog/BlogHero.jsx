    ...
    >
      ...
      <div className="relative max-w-4xl">
        ...
        >
          ...
          Stay inspired with the latest trends, design ideas, and deep dives into our creative journey.
        </motion.p>
      </div>
      ...
      >
        <span className="text-light text-lg font-medium">Read Articles →</span>
      </motion.div>
    </motion.section>
  );
};
